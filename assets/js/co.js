...
var urlCtrl = {
	...
	loadableUrls : {
	    ...
	    "#admin.view.checkgeocodage" : {title:'CHECKGEOCODAGE ', icon : 'download', useHeader: true},
	    "#admin.view.openagenda" : {title:'OPENAGENDA ', icon : 'download', useHeader: true},
	    "#admin.view.adddata" : {title:'ADDDATA ', icon : 'download', useHeader: true},
	    "#admin.view.importdata" : {title:'IMPORT DATA ', icon : 'download', useHeader: true},
	    //"#admin.view.index" : {title:'IMPORT DATA ', icon : 'download', useHeader: true},
	    "#admin.view.cities" : {title:'CITIES ', icon : 'university', useHeader: true},
	    "#admin.view.sourceadmin" : {title:'SOURCE ADMIN', icon : 'download', useHeader: true},
	    "#admin.view.checkcities" : {title:'SOURCE ADMIN', icon : 'download', useHeader: true},
	    "#admin.view.directory" : {title:'IMPORT DATA ', icon : 'download', useHeader: true},
	    "#admin.view.mailerrordashboard" : {title:'MAIL ERROR ', icon : 'download', useHeader: true},
	    "#admin.view.moderate" : {title:'MODERATE ', icon : 'download', useHeader: true},
	    "#admin.view.createfile" : {title:'IMPORT DATA', icon : 'download', useHeader: true},
