dynForm = {
    jsonSchema : {
	    ...
	    properties : {
	        ...
	        type : dyFInputs.inputSelect(tradDynForm["prestationType"], tradDynForm["prestationType"], pretationsTypes, { required : true }),
            role : dyFInputs.inputHidden("admin"),
            toModerate : dyFInputs.inputHidden(true),
            tags : dyFInputs.tags(),
