...
* ************************************************************  
** @Tib
[ ] personne.annonce > n'ouvre pas preview
[ ] ouvrir POI dans PREVIEW
[ ] je peux ajouter une annonce sur un autre user ????
[ ] Modifier annonce pour un citoyen formulaire pas afficher [[https://github.com/pixelhumain/co2/issues/213]]
