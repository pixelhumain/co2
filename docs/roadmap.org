...
* idea
 ...
 [ ] make this our homepage , ex : a rpopos
 [ ] drawing our puzzle funding 
  [ ] what are the pieces of the puzzle 
* ************************************************************    
* Version 0.21  : en cours
* ************************************************************  
* Action Terrain 
...
* DEV
  ...
  ** @tango
  ...
  [ ] delete mapIconTop into typeObj
  ** @Clem
  [ ] on dynform, input name : paste url > get + fills max inputs
    [ ] also on add news > propose add as element > choose type fills infos 
  ...
  [ ] Add # in news text
  [ ] Translate website (get spanish trad from poupou or others)
    [ ] Create template of co-working on language translation and add language (wishlist)
  [ ] Banniere rework 
    [ ] Save cropping
    [ ] Redimension main image as 1600*... or 1000*... 
    [ ] Limitation of 500px*100px
