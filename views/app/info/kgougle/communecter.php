...
<section class="padding-top-70">
    <div class="row padding-20 main-apropos padding-top-15 padding-bottom-50">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			...
			<span class="letter-red">Communecter</span> c’est une plateforme web portée par le collectif <a href="#info.p.ph" class="lbh letter-yellow">Pixel Humain</a> dans lequel les citoyens sont connectés a leur commune.
...
jQuery(document).ready(function() {
    initKInterface();
    location.hash = "#info.p.communecter";
});
