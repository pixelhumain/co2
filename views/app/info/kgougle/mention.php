...
/*.fa-caret-right{font-size:56px;line-height: 10px;}*/
...
<section class="padding-top-70">
    <div class="row padding-20 main-apropos padding-top-15 padding-bottom-50">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Editeur du Site </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Hébergement </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Développement </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Conditions d’utilisation </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Services fournis </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Limitation contractuelles sur les données</h5>
			<div class="explainDesc">
			...
			<!-- <h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Propriété intellectuelle </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
			...
			<!-- <h5 class=" explainTitle"> Déclaration à la CNIL </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Litiges </h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
			...
			<h5 class=" explainTitle"><i class="fa fa-caret-right"></i> Données personnelles</h5>
			<center class="caretExplain"><i class="fa fa-caret-right"></i><br/></center>
			<div class="explainDesc">
