        ...
        <div class="container linksmo">
            ...
            <div class="col-xs-12"  style="margin-top:50px">
                <div class="col-xs-6">
                    ...
                    <h2 class="text-right"><a href="https://github.com/pixelhumain/communecter/wiki" target="_blank">WIKI DOCS</a></h2>
                    <h2 class="text-right"><a href="https://github.com/pixelhumain/co2/issues" target="_blank">Déclarer des bugs</a></h2>
                </div>

                <div class="col-xs-6">
                    <h1><span class="text-red">CO</span>NNECTER</h1>
                    <h2 class="text-left"><a href="https://chat.lescommuns.org" target="_blank">Open CHAT</a></h2>
                    <h2 class="text-left"><a href="https://twitter.com/communecter" target="_blank">Twitter</a></h2>
                    <h2 class="text-left"><a href="https://mamot.fr" target="_blank">MASTODON</a></h2>
                    <h2 class="text-left"><a href="https://www.facebook.com/communecter" target="_blank">FB</a></h2>
                    <h2 class="text-left"><a href="https://github.com/pixelhumain/buildingCommons/blob/master/codeSocialOpenSystem.md" target="_blank">Code Social : Open Système</a></h2>
                </div>
            </div>
