...
function bindInviteModal(){
	...
	$("#invite-modal-element  #btn-save-invite").off().on('click', function(){
    	...
    	/*else if($("#invite-modal-element #inviteEmail").val()=="" || $("#invite-modal-element #inviteName").val()==""){
    		mylog.log("here 2");
    		if($("#invite-modal-element #inviteEmail").val()=="" && $("#invite-modal-element #inviteEmail").parent().find(".error-block-invite").length <=0)
    			$("#invite-modal-element #step3 #inviteEmail").parent().append("<span class='text-red error-block-invite'><i>* Veuillez ajouter un email</i></span>");
    		if($("#invite-modal-element #inviteName").val()=="" && $("#invite-modal-element #inviteName").parent().find(".error-block-invite").length <=0)
