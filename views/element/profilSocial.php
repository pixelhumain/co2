    	...
    	<div class="btn-group inline">
  		...
  		if( ($type!=Person::COLLECTION && ((@$edit && $edit) || (@$openEdition && $openEdition))) || 
  			...
  			{ 
  				...
  				?>
		  <button type="button" onclick="javascript:rcObj.loadChat('<?php echo $loadChat;?>','<?php echo $type?>',<?php echo $canEdit;?>,<?php echo $hasRC;?> )" class="btn btn-default bold btnChatColor <?php echo $chatColor;?> hidden-xs" 
		  		  id="open-rocketChat" style="border-right:0px!important;">
