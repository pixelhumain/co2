...
var trad = {
	...
	"explainbookmark" : "<?php echo Yii::t("common","It is here to collect<br> urls that you like<br>And share it also") ?>",
	"explainfile" : "<?php echo Yii::t("common","It is here to collect<br>documents<br>and share it") ?>",
